...
scp -i ~/.ssh/mvp-key-pair-server.pem /Users/linusweigand/Documents/CodeProjects/rust/Bachelor/Bachelor3/microbenchmarks/target/x86_64-unknown-linux-gnu/release/disk-write ec2-user@$IP:/home/ec2-user/
